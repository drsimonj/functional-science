...
Once you being to master programming languages, you quickly learn that there are a potentially infinite number of ways to achieve the same outcome.

I will try to focus on fundamental approaches, but be aware that everything you do is not the only approach, nor is it usually the best approach.

In general, value code that is consistent and understandable. 
