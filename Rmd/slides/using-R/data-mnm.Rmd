...
Selecting rows based on conditions involves two steps (though the can be combined into one line of code).
...
For convenicence, you can assign this to a vector variable:
