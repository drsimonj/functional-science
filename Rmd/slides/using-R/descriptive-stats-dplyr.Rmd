...
Most functions that help us to describe a univariate distribution take a vector of values (our variable) as the first arguement.

Subsequent arguments are specific to the function.

Commonly, they do NOT accept missing values. To override this, `na.rm = TRUE` must be added as an arguement.
